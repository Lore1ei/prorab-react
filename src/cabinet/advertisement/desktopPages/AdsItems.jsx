...
const AdsItems = ({ getIdItem, type, onPageChange, deactivateHandler }) => {
    ...
    useEffect(() => {
        fetch(`https://cc19244api.tmweb.ru/object?filter[type]=${type}&filter[user_id]=${ctx.isUserId}&filter[status][neq]=4`,
            {
                headers: {
                    'Accept': 'application/json',
                    'Authorization': token,
    ...
    }, [type, ctx.rerender, ctx.isUserId]);
