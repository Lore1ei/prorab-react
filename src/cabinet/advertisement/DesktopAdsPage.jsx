...
const DesktopAdsPage = ({ category, deactivateHandler }) => {
    ...
    return (
      <div className="cabinet_ads">
        <div className="cabinet_ads__left">
          ...
          <AdsItems type={type} onPageChange={setCurrentPage} getIdItem={setAdId} id={adId} deactivateHandler={deactivateHandler}/>
        </div>
